"""
Django settings for ShoppingPrj project.
...
SECRET_KEY = 'django-insecure-0+92*3g-7&avw^2b(+y*c9#%=*v#*49^ov#!)9a_a_iv!wo%lr'
...
WSGI_APPLICATION = 'ShoppingPrj.wsgi.application'
